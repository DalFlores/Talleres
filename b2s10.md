...
<img width="814" height="627" alt="image" src="https://github.com/user-attachments/assets/d8e221c0-aa03-4d98-8c4a-98bf60a50cc7" />
...
object Problema_B extends App {

  val masa = Var(1000.0) // kg
  val velocidad = Var(30.0) // m/s
  ...
  velocidad.set(50.0) //Actulizamos la velocidad a 50 m/s
  masa.set(2000.0) // Actuliazmos la masa a 2000 kg
}
```
...
```
**Captura**
<img width="1029" height="678" alt="image" src="https://github.com/user-attachments/assets/c181e9d0-930a-4af2-98b0-b6da310ca6ec" />
